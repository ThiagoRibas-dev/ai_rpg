...
- [ ] Create new prompt with initial_message
- [ ] Verify prompt is saved with all 3 fields
- [ ] Load prompt and verify initial_message persists

### Phase 2: UI Cleanup
- [ ] Memory field no longer visible in Advanced Context panel
- [ ] Save Context button still works (saves only author's note)
- [ ] No console errors related to missing memory widgets

### Phase 3: New Prompt Dialog
- [ ] Click "New" button opens 3-field dialog
- [ ] All fields are editable and properly labeled
- [ ] Cancel button closes without saving
- [ ] Save button validates and creates prompt
- [ ] Edit button opens dialog with existing data pre-filled

### Phase 4: Initial Message
- [ ] Create new game with prompt that has initial_message
- [ ] Chat starts with GM's initial message already visible
- [ ] Message is properly saved in session history
- [ ] Loading saved game shows initial message

### Phase 5: SETUP Scaffolding
- [ ] New game creates scaffolding in database
- [ ] AI can query scaffolding with state.query
- [ ] AI updates scaffolding instead of creating from scratch
- [ ] Genre detection works for fantasy/scifi/horror/cyberpunk
- [ ] Generic scaffolding used when genre is unclear

---

## Migration & Deployment Notes

1. **Database Migration:** Run `migration_add_initial_message.py` BEFORE starting the app with new code
2. **Existing Prompts:** Will have empty `initial_message` field (safe default)
3. **Existing Sessions:** Will continue to work normally (no initial message on load)
4. **New Sessions:** Will benefit from all new features

---

## Future Enhancements (Not in Scope)

- [ ] Prompt templates (quick-start prompts for common genres)
- [ ] Scaffolding editor (visual tool to customize templates)
- [ ] Import/export scaffolding as JSON files
- [ ] AI-suggested custom properties based on prompt analysis