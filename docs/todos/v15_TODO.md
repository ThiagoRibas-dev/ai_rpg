...
- [x] **1.1. Clean House (Deprecations)**
...
- [x] **1.2. Restrict `character.update`**
...
- [x] **2.1. Implement `LocationCreate` Tool**
...
- [x] **2.2. Implement `LocationConnect` Tool**
...
- [x] **2.3. Refactor `scene.move_to` (Validation)**
...
- [x] **2.4. Context Injection (The HUD)**
...
- [x] **3.1. Implement `CharacterApplyDamage`**
...
- [x] **4.2. Implement Summarization Trigger**
...
- [x] **4.4. Implement `JournalAddEntry`**
...
- [x] **5.1. Implement `LocationCard` Widget**
...
- [x] **5.2. Implement Navigation Buttons**
...
- [x] **5.3. Interactive Text (Entity Tooltips)**
    *   **File:** `app/gui/managers/chat_bubble_manager.py`
    *   **Action:**
        *   Parse text for `**Name**`.
