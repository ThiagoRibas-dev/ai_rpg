...
class MainPanelBuilder:
    ...
    def build(parent: ctk.CTk, send_callback: Callable) -> Dict[str, Any]:
        ...
        game_time_frame.grid(row=0, column=0, columnspan=2, sticky="ew", 
        ...
        game_time_label.pack(side="left", padx=Theme.spacing.padding_md, 
        ...
        game_mode_label.pack(side="left", expand=True, 
        ...
        session_name_label.pack(side="right", padx=Theme.spacing.padding_md, 
                                pady=Theme.spacing.padding_sm)
        ...
        chat_history_frame.grid(row=1, column=0, columnspan=2, sticky="nsew", 
                               padx=Theme.spacing.padding_sm, 
                               pady=Theme.spacing.padding_sm)
