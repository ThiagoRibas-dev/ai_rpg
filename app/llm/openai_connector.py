    ...
    def get_structured_response(self, system_prompt: str, chat_history: List[Message], output_schema: Type[BaseModel]) -> BaseModel:
        ...
        try:
            ...
            if hasattr(validated, 'tool_calls'):
                logger.debug(f"Validated response with {len(validated.tool_calls)} tool calls")
            ...
            try:
                ...
                logger.error("Failed to parse raw content as dict after initial JSON decode error.")
                pass
