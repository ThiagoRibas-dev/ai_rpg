...
# We are replacing the whole file to fundamentally change how Lore is handled in the UI state.
# From: Single String (edit_lore_text)
# To:   List of Dicts (lore_ui_items)

wizard_code = """from nicegui import ui
import asyncio
import logging
...
with open("app/gui/dialogs/setup_wizard.py", "w", encoding="utf-8") as f:
    f.write(wizard_code)

print("✅ Patched SetupWizard to preserve AI-generated tags via list UI.")